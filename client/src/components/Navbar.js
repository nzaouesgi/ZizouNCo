        ...
        <nav className="bg-white shadow">
            <div className="max-w-7xl flex mx-auto">
                ...
                <div className="space-x-5 flex">
                    ...
                    <NavLink to="/create" activeClassName="text-gray-900 border-b-2 border-yellow-600" className="inline-flex items-center px-1 pt-1 text-md font-medium text-gray-500 focus:outline-none hover:text-gray-700">Create</NavLink>
                </div>
            </div>
        </nav>
    )
